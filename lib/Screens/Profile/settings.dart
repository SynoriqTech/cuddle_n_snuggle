...
// import 'package:cns/ads/ads.dart';
...
//     //     : 400;
//     setState(() {
// //      if (!widget.isPurchased && currentUser.maxDistance > freeR) {
// //        currentUser.maxDistance = freeR.round();
// //        changeValues.addAll({'maximum_distance': freeR.round()});
// //      } else if (widget.isPurchased &&
// //          currentUser.maxDistance >= paidR) {
// //        currentUser.maxDistance = paidR.round();
// //        changeValues.addAll({'maximum_distance': paidR.round()});
// //      }
// //       _showMe = currentUser.showGender;
// //       distance = currentUser.maxDistance.round();
// //       ageRange = RangeValues(double.parse(currentUser.ageRange['min']),
// //           (double.parse(currentUser.ageRange['max'])));
//     });
//   }
...
//                   onTap: () {
//                     Share.share(
//                         'Check this amazing pet dating app https://cuddlesandsnugglesindia.com', //Replace with your dynamic link and msg for invite users
